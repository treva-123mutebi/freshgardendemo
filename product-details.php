...
<html lang="en">
	<head>
		...
		<meta name="author" content="Mutebi David Trevor">
	    <meta name="keywords" content="Fresh Garden, Uganda, Healthy">
					...
					<div class="products">
						...
						<div class="product-info text-left m-t-20">
							...
							<div class="product-price">	
								<span class="price">
									Ugx. <?php //echo htmlentities($rws['productPrice']);?>.00
								</span>
					...
					<div class="row">
						<div class="col-sm-3">
							<ul id="product-tabs" class="nav nav-tabs nav-tab-cell">
								<li class="active"><a data-toggle="tab" href="#description">Nutrients</a></li>
								<li><a data-toggle="tab" href="#vitamins">Vitamins</a></li>
								<li><a data-toggle="tab" href="#minerals">Minerals</a></li>
								<li><a data-toggle="tab" href="#pros">Pros:</a></li>
								<li><a data-toggle="tab" href="#cons">Cons:</a></li>
							...
							<div class="tab-content">
								...
								<div id="description" class="tab-pane in active">
									...
									<th>
										...
										<th><?php echo $row['energy'];?> .kcal</th>
									</tr>
									<tr>
									<th>
								...
								<div id="vitamins" class="tab-pane">
									<div class="product-tab">
									<table id="datatable" class="table table-striped table-bordered table-responsive">
									<thead>
									<tr>
									...
									<tr>
									<th>Vitamin A</th>
									<th><?php echo $row['vitaminaqty'];?>.mg</th>
									<th><?php echo $row['vitaminadv'];?>.%</th>
									</tr>
									<tr>
									<th>Vitamin C</th>
									<th><?php echo $row['vitamincqty'];?>.mg</th>
									<th><?php echo $row['vitamincdv'];?>.%</th>
									</tr>
									<tr>
									<th>Vitamin K</th>
									<th><?php echo $row['vitaminkqty'];?>.mg</th>
									<th><?php echo $row['vitaminkdv'];?>.%</th>
									</tr>
									<tr>
									<th>Thiamin B1</th>
									<th><?php echo $row['thiaminb1qty'];?>.mg</th>
									<th><?php echo $row['thiaminb1dv'];?>.%</th>
									</tr>
									<tr>
									<th>Riboflavin B2</th>
									<th><?php echo $row['riboflavinb2qty'];?>.mg</th>
									<th><?php echo $row['riboflavinb2dv'];?>.%</th>
									</tr>
									<tr>
									<th>Niacin B3</th>
									<th><?php echo $row['niacinb3qty'];?>.mg</th>
									<th><?php echo $row['niacinb3dv'];?>.%</th>
									</tr>
									<tr>
									<th>Vitamin B6</th>
									<th><?php echo $row['vitaminb6qty'];?>.mg</th>
									<th><?php echo $row['vitaminb6dv'];?>.%</th>
									</tr>
									</tbody>
									</table>
									</div>	
								</div><!-- /.tab-pane -->
								<div id="minerals" class="tab-pane">
									<div class="product-tab">
									<table id="datatable" class="table table-striped table-bordered table-responsive">
									<thead>
									<tr>
									...
									<tr>
									<th>Calcium</th>
									<th><?php echo $row['calciumqty'];?>.mg</th>
									<th><?php echo $row['calciumdv'];?>.%</th>
									</tr>
									<tr>
									<th>Iron</th>
									<th><?php echo $row['ironqty'];?>.mg</th>
									<th><?php echo $row['irondv'];?>.%</th>
									</tr>
									<tr>
									<th>Magnesium</th>
									<th><?php echo $row['magnesiumqty'];?>.mg</th>
									<th><?php echo $row['magnesiumdv'];?>.%</th>
									</tr>
									<tr>
									<th>Manganese</th>
									<th><?php echo $row['manganeseqty'];?>.mg</th>
									<th><?php echo $row['manganesedv'];?>.%</th>
									</tr>
									<tr>
									<th>Phosphorus</th>
									<th><?php echo $row['phosphorusqty'];?>.mg</th>
									<th><?php echo $row['phosphorusdv'];?>.%</th>
									</tr>
									<tr>
									<th>Sodium</th>
									<th><?php echo $row['sodiumqty'];?>.mg</th>
									<th><?php echo $row['sodiumdv'];?>.%</th>
									</tr>
									<tr>
									<th>Zinc</th>
									<th><?php echo $row['zincqty'];?>.mg</th>
									<th><?php echo $row['zincdv'];?>.%</th>
									</tr>
									</tbody>
									</table>
									</div>	
...
<section class="section featured-product wow fadeInUp">
	<h3 class="section-title">Great Discounts </h3>
