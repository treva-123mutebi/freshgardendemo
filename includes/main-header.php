...
<div class="search-area">
    <form name="search" method="post" action="search-result.php">
        <div class="control-group">
            ...
            <input class="search-field" placeholder="Onion, Tomatoes" name="product" required="required" />
	...
	?>
			...
			<div class="clearfix cart-total">
				<div class="pull-right">
						...
						<span class="text">Total :</span><span class='price'>Ugx.<?php echo $_SESSION['tp']="$totalprice". ".00"; ?></span>
