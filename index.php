...
<html lang="en">
	<head>
		...
		<meta name="description" content="fresh Garden number one site to buy vegetables and fresh foodstuff">
		<meta name="author" content="">
	    <meta name="keywords" content="Fresh, Food, Uganda, Garden">
...
<div id="hero" class="homepage-slider3">
	<div id="owl-main" class="owl-carousel owl-inner-nav owl-ui-sm">
		<div class="full-width-slider">	
			<div class="item" style="background-image: url(http://adwallpapers.xyz/uploads/posts/6823-large-group-of-food-and-drinks-isolated-on-white-background.jpg);">
				<!-- /.container-fluid -->
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
	    
	    <div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(http://adwallpapers.xyz/uploads/posts/80328-fresh-juice-drinks-4k-ultra-hd-wallpaper.jpg);">
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading green">Welcome</h4>
						</div>
					</div>	
					<h6 class="text">Best Offer in Uganda.</h6>
				</div>
			</div><!-- .col -->
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading orange">Fast</h4>
						</div>
					</div>
					<h6 class="text">And Cheap delivery </h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="col-md-6 col-sm-4 col-lg-4">
				<div class="info-box">
					<div class="row">
						...
						<div class="col-xs-10">
							<h4 class="info-box-heading red">Special Discounts</h4>
						</div>
					</div>
					<h6 class="text">Up to 20% off </h6>	
				</div>
			</div><!-- .col -->
		</div><!-- /.row -->
...
<!-- ============================================== INFO BOXES : END ============================================== -->		
		...
		<div id="product-tabs-slider" class="scroll-tabs inner-bottom-vs  wow fadeInUp">
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Healthy living</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					<li class="active"><a href="#all" data-toggle="tab">All</a></li>
					<li><a href="#books" data-toggle="tab">Fast Buy</a></li>
					<li><a href="#furniture" data-toggle="tab">On Discount</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
				...
				<div class="row">
					<div class="col-md-6">
	                   <section class="section">
	                   	<h3 class="section-title">Great Discount</h3>
